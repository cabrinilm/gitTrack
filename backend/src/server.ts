...
import { getMyFulfillActivitiesByDate, getMyHeatMapData, postMyFulfillActivity, getMyStreak } from "./controllers/fulfillments.controller";
...
app.get("/api/progress/:date/fulfillments", getMyFulfillActivitiesByDate);
